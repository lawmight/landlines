...
export const env = createEnv({
  server: {
    ...
    POLAR_PRO_MONTHLY_PRICE_ID: nonEmptyString.optional(),
    POLAR_PRO_ANNUALLY_PRICE_ID: nonEmptyString.optional(),
  ...
  runtimeEnv: {
    ...
    POLAR_PRO_MONTHLY_PRICE_ID: process.env.POLAR_PRO_MONTHLY_PRICE_ID,
    POLAR_PRO_ANNUALLY_PRICE_ID: process.env.POLAR_PRO_ANNUALLY_PRICE_ID,
